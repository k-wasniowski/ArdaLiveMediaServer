...
namespace Media
{
    namespace Sdp
    {
        ...
        using CryptoAttributeSharedPtr_t = std::shared_ptr<CryptoAttribute>;

        class CryptoAttribute : public Attribute
        {
        public:
            class KeyParam;
            using KeyParamSharedPtr_t = std::shared_ptr<KeyParam>;
        ...
        public:
            ...
            CryptoAttribute(int tag,
                            ...
                            const std::string& sessionParams)
            {
                this->tag = tag;
                this->suite = suite;
            ...
            CryptoAttribute(
                int tag, const std::string& suite, const std::string& method, const std::string& info, const std::string& sessionParams)
            {
                this->tag = tag;
                this->suite = suite;
