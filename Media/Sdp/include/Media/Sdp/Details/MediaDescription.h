...
#include <Media/Sdp/Details/FormatAttribute.h>
#include <Media/Sdp/Details/Information.h>
#include <Media/Sdp/Details/Key.h>
#include <Media/Sdp/Details/RTPMapAttribute.h>
...
namespace Media
{
    namespace Sdp
    {
        ...
        using MediaDescriptionSharedPtr_t = std::shared_ptr<MediaDescription>;
        ...
        public:
            ...
            MediaDescriptionSharedPtr_t clone()
            {
                // Serialize protocol
                std::string value = "";
                bool first = true;
            ...
            void addCandidate(const std::string& fundation,
                              int componentId,
